...
float corrected_battery_percentage() {
    // we need to map the vesc percentage (which is a linear map from 3.0-4.2V) to a battery percentage
    // based on a cell boltage table such as
    float battVoltages[11] = {4.2, 4.054, 4.01, 3.908, 3.827, 3.74, 3.651, 3.571, 3.485, 3.38, 3.0}; //P42A
